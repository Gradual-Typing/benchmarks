...
declare -a BENCHMARKS_ARGS_PARTIAL_COARSE=("fast.txt" "medium1.txt" "in_4K.txt" "slow.txt" "empty.txt" "in_descend1000.txt" "400.txt" "slow.txt" "slow.txt")

declare -a BENCHMARKS_ARGS_PARTIAL_FINE=("trivial.txt" "medium1.txt" "in_4K.txt" "slow.txt" "empty.txt" "in_descend1000.txt" "400.txt" "slow.txt" "slow.txt")
